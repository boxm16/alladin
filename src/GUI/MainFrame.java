...
public class MainFrame extends javax.swing.JFrame {
    ...
    DefaultTableModel customerItems4 = new DefaultTableModel();
    private int x = 0;
...
//for rendning, row color change ,depended on ready-not ready;
    ...
    private void initComponents() {
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jPanel7, javax.swing.GroupLayout.PREFERRED_SIZE, 1734, Short.MAX_VALUE)
                    .addGroup(jPanel5Layout.createSequentialGroup()
        ...
        TotalTable.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        ...
        AllTable.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        ...
        AllTable.setRowHeight(28);
        jScrollPane8.setViewportView(AllTable);

        jButton14.setText("ΟΛΑ ΤΑ ΤΕΜΑΧΙΑ");
        ...
        jButton15.setText("ΕΤΟΙΜΑ ΤΕΜΑΧΙΑ");
        ...
        jPanel12Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel12Layout.createSequentialGroup()
                .addComponent(jScrollPane8, javax.swing.GroupLayout.DEFAULT_SIZE, 1705, Short.MAX_VALUE)
                .addContainerGap())
            .addGroup(jPanel12Layout.createSequentialGroup()
                .addGap(25, 25, 25)
        ...
        jTabbedPane1.addTab("ΤΕΜΑΧΙΑ", jPanel12);
...
// TODO add your handling code here:
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        DefaultTableModel model1 = new MyDefaultModel();
        model1.setColumnIdentifiers(headers);

        for (Item item : items) {
            data[0] = item.getStatus();
            data[1] = item.getItemCode();
            data[2] = item.getProduct_description();
            data[3] = item.getCleaning();
            data[4] = item.getStoring();
            data[5] = item.getMending();
            data[6] = item.getCleaning_price();
            data[7] = item.getStoring_price();
            data[8] = item.getMending_price();
            data[9] = new Boolean(true);
            model.addRow(data);
            model1.addRow(data);
        }
        ...
        DefaultTableModel model2 = new DefaultTableModel(data1, columnNames) {
...
//why it could not be like model.setCellEditable(x,y)
    ...
    private void jButton14ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton14ActionPerformed
        ...
        columns[0] = "ΚΩΔΙΚΟΣ ΠΡΟΙΝΟΝΤΟΣ";
        columns[1] = "ΠΕΡΙΓΡΑΦΗ ΠΡΟΙΟΝΤΟΣ";
        columns[2] = "ΚΩΔΙΚΟΣ ΤΕΜΑΧΙΟ";

        columns[3] = "ΚΑΘΑΡΙΣΜΑ";
        columns[4] = "ΦΥΛΑΞΗ";
        columns[5] = "ΕΠΙΔΙΟΡΘΩΣΗ";

        columns[6] = "ΤΙΜΗ ΚΑΘΑΡΙΣΜΑΤΟΣ";
        columns[7] = "ΤΙΜΗ ΦΥΛΑΞΗΣ";
        columns[8] = "ΤΙΜΗ ΕΠΙΔΙΟΡΘΩΣΗΣ";

        columns[9] = "ΜΗΚΟΣ";
        columns[10] = "ΠΛΑΤΟΣ";
        columns[11] = "ΤΑΤΡΑΓΩΝΙΚΟ";
        ...
        for (Item item : items) {
            ...
            row[8] = item.getMending_price();
            Double a, b, s;
            row[9] = a = item.getLength();
            row[10] = b = item.getWidth();
            row[11] = s = a * b;
            Double x, y, z;
            row[12] = x = item.getCleaningCharge();
            row[13] = y = item.getStoringCharge();
            row[14] = z = item.getMendingCharge();
    ...
    private void countTotal(DefaultTableModel model) {
        ...
        TotalTable.getModel().setValueAt(String.valueOf(total * 24 / 100), 1, 1);
        TotalTable.getModel().setValueAt(String.valueOf((total * 24 / 100) + total), 2, 1);
        TotalTable.setTableHeader(null);
        TotalTable.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
        TotalTable.getColumnModel().getColumn(0).setPreferredWidth(200);
    ...
    private void addHeaders() {
        ...
        //jTable5.getTableHeader().setFont(new Font("SansSerif", Font.BOLD, 36));
    }
    ...
    private void addHeaders4() {
        ...
        customerItems4.setColumnIdentifiers(columns);

    }

    private void populateTable4(ArrayList<Item> customersItems) {
        ...
        for (Item item : customersItems) {
            ...
            row[9] = item.getNote();
            row[10] = new Boolean(true);

            customerItems4.addRow(row);
        }
